...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Merah Magenta (#C2185B) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #C2185B}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#C2185B;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#C2185B;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#C2185B;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone magenta soft/rose tint (#FDF0F5) */
    '.info-box{background:#FDF0F5;border:1px solid #F4B8DA;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Merah Magenta (#C2185B) */
    '.paket-box{background:#C2185B;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#FFFAFC;border:1px solid #F8D7E8;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft magenta/blush (#F8E8F0) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#F8E8F0;border:1px solid #E4A1C8;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#880E4F;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #F4B8DA;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
